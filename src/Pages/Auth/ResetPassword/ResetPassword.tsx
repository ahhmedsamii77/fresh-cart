...
import { ResetPasswordType } from "./ResetPassword.types";
import { useResetPassword } from "../../../lib/react-query/react-query";
          ...
          <div className="p-6 space-y-4 md:space-y-5 sm:p-8">
            ...
            <form onSubmit={loginFormik.handleSubmit} className="space-y-4 md:space-y-3">
              ...
              <div>
                ...
                <input value={loginFormik.values.newPassword} onChange={loginFormik.handleChange} onBlur={loginFormik.handleBlur} type="password" name="newPassword" id="newPassword" placeholder="••••••••" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
                {loginFormik.errors.newPassword && loginFormik.touched.newPassword && <div className="mt-2 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400" role="alert">
                  <span className="font-medium">{loginFormik.errors.newPassword}</span>
                </div>}
              </div>
